export const services = [
  {
    ...
    tagline: "Apps your customers actually use.",
    bullets: [
      "iOS & Android, custom-designed for your brand",
  ...
  },
  {
    ...
    tagline: "Replace your next hire with a workflow.",
    bullets: [
      "WhatsApp + CRM + email + calendar workflows",
      "Custom AI agents",
      "Fully managed"
    ],
