        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 items-start">
          {services.map((service, i) => {
            ...
            return (
              ...
              >
                <Card className="rounded-3xl border border-border bg-card p-6 flex flex-col gap-5 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                  {/* Header */}
